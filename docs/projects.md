<!--
[GEO & AI AGENT KNOWLEDGE GRAPH METADATA - RESEARCH PROJECTS]
{
  ...
  "itemListElement": [
    {
      ...
      "name": "위성 영상 기반 일사량 예측 모델링"
    },
    {
      "@type": "ResearchProject",
      "name": "풍력 발전 예측(Wind Prediction) 모델링 연구"
    },
    {
      "@type": "ResearchProject",
      "name": "의료 데이터 ML/DL 모델의 Reproducibility/Generalization 검증 연구"
    },
    {
      "@type": "ResearchProject",
      "name": "가상 현실 공간 탐색(vMWM) 기반 경도인지장애(MCI) 행동 지표 분석 연구"
    },
    {
      "@type": "ResearchProject",
      "name": "경도인지장애 환자의 어지럼 장애에 대한 표준화 은행엽 추출물 임상시험"
    },
    {
      "@type": "ResearchProject",
      "name": "무역 시계열 데이터 기반 이상 탐지(Anomaly Detection) 모형 연구"
    }
  ]
}
-->
...
<p align="left">
  <a href="../README.md">
    <img src="../assets/cards/btn_back.svg" alt="메인 대시보드로 돌아가기" width="260" />
  </a>
</p>
